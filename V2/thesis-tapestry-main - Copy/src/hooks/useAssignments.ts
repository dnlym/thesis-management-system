...
export function useAssignReviewer() {
    ...
    return useMutation({
        ...
        onError: (error: any) => {
            toast.error(error?.response?.data?.message || 'Phân công phản biện thất bại');
        },
    });
}
...
export function useAcceptAssignment() {
    ...
    return useMutation({
        ...
        onError: (error: any) => {
            toast.error(error?.response?.data?.message || 'Chấp nhận phân công thất bại');
        },
    });
}
...
export function useDeclineAssignment() {
    ...
    return useMutation({
        ...
        onError: (error: any) => {
            toast.error(error?.response?.data?.message || 'Từ chối phân công thất bại');
        },
    });
}
...
export function useCreateDefenseSchedule() {
    ...
    return useMutation({
        ...
        onError: (error: any) => {
            toast.error(error?.response?.data?.message || 'Tạo lịch bảo vệ thất bại');
        },
    });
}
