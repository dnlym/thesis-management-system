                        ...
                        <div className="flex flex-wrap items-center gap-2 py-2">
                            {[
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-4 py-2 rounded-xl font-bold transition-all duration-200 border-none outline-none cursor-pointer ${activeTab === tab.key
